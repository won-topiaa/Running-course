...
// 도는 코스입니다. 통로를 공원 밖까지 부풀리지 않는 쪽을 택했습니다.
// scripts/course-path-check.mjs 가 이 두 규칙을 각각 검사합니다.
//
// 바퀴 수는 Course.laps 로 적을 수 있습니다(없으면 1바퀴). 지금은 어느 코스도
// 적어 두지 않았습니다 — 위 통로 길이는 직선 거리라 실제 라우팅 거리보다
// 짧게 나오고, 그 숫자로 바퀴 수를 정하면 실측이 아니라 추측을 데이터에
// 굳히는 셈이기 때문입니다. 대신 앱이 실제 라우팅된 한 바퀴 거리로 바퀴 수를
// 추정합니다(types.ts 의 courseLaps). 각 공원의 한 바퀴 거리를 실측하면
// 그때 laps 를 적어 추정을 대체하면 됩니다.
// ---------------------------------------------------------------------------
